...
export type GetLessonsQueryQuery = {
  __typename?: 'Query'
  lessons: Array<{
    __typename?: 'Lesson'
    id: string
 ...
 * });
 */
export function useGetLessonsQueryQuery(
  baseOptions?: Apollo.QueryHookOptions<
    GetLessonsQueryQuery,
    GetLessonsQueryQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useQuery<GetLessonsQueryQuery, GetLessonsQueryQueryVariables>(
    GetLessonsQueryDocument,
    options
  )
}
export function useGetLessonsQueryLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    GetLessonsQueryQuery,
    GetLessonsQueryQueryVariables
  >
  ...
  return Apollo.useLazyQuery<
    GetLessonsQueryQuery,
    GetLessonsQueryQueryVariables
  >(GetLessonsQueryDocument, options)
}
export type GetLessonsQueryQueryHookResult = ReturnType<
  typeof useGetLessonsQueryQuery
>
export type GetLessonsQueryLazyQueryHookResult = ReturnType<
  typeof useGetLessonsQueryLazyQuery
>
export type GetLessonsQueryQueryResult = Apollo.QueryResult<
  GetLessonsQueryQuery,
  GetLessonsQueryQueryVariables
>
